...
AS $$
DECLARE
  project_url TEXT := 'https://hlfwrapetalxadubmrcq.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhsZndyYXBldGFseGFkdWJtcmNxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTY4MjAyNSwiZXhwIjoyMDI1MjU4MDI1fQ.bWLk7ar8kY0E7rRRwQ8aHUmwblS9x3gTXATcVEP_DG4'; -- full access needed for http request to storage
